 ...
 *                                                                         *
 ***************************************************************************/
#ifndef __Nimm4Angle_H_ANGLE
#define __Nimm4Angle_H_ANGLE
...
namespace lpzrobots {
  ...
  */
  class Nimm4Angle : public OdeRobot{
  public:

    /**
     * constructor of Nimm4Angle robot
     ...
     */
    Nimm4Angle(const OdeHandle& odeHandle, const OsgHandle& osgHandle, const std::string& name,
